...
myLegendContainer1.innerHTML = statisticsChart1.generateLegend();

var legendItems1 = myLegendContainer1.getElementsByTagName('li');
for (var i = 0; i < legendItems1.length; i++) {
...
for (var i = 0; i < legendItems2.length; i++) {
...
for (var i = 0; i < legendItems3.length; i++) {
...
for (var i = 0; i < legendItems4.length; i++) {
